...
var BleDeviceService = /** @class */ (function () {
    function BleDeviceService() {
        this.theDevice = BleDevice("", "");
    }
    BleDeviceService.prototype.add = function (msg) {
        this.logs.push(new Logentry(msg));
    };
    BleDeviceService.prototype.clear = function () {
        this.logs = [];
    };
